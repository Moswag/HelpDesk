...
@section('content')
                        ...
                        <table id="datatable" class="table table-striped table-bordered" cellspacing="0"
                            ...
                            @foreach($employees as $employee)
                                <tr>
                                    ...
                                    <td>{{
                                    \App\Department::find($employee->department_id)->name }}</td>
                                    <td>{{$employee->desk_phone}}</td>
    ...
    <!--  Plugin for Switches, full ocumentation here: http://www.jque.re/plugins/version3/bootstrap.switch/ -->
