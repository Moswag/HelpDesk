...
<head>
    ...
    <meta name="twitter:image"
          content="s3.amazonaws.com/creativetim_bucket/products/72/opt_nudp_thumbnail.jpg">
                    ...
                    <form class="form" method="post" action="{{route('login')}}">
                        ...
                        <div class="card card-login card-plain">
                            ...
                            <div class="card-header ">
                                    ...
                                    <img src="assets/img/logo.png" alt="" style="width:600px;height:200px;">
                            ...
                            <div class="card-footer ">
                                <button type="submit" class="btn btn-success btn-round btn-lg btn-block mb-3">Login</button>
...
<!-- Mirrored from demos.creative-tim.com/now-ui-dashboard-pro/examples/pages/login.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 19 May 2019 14:19:00 GMT -->
</html>
